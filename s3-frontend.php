        ...
        <div class="my-auto">
            <form action="includes/s3-upload-helper.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <img src="uploads/generic.jpg" onclick="triggered();" id="s3-display">
                ...
                <div class="form-group">
                    <button type="submit" name="s3-submit" class="btn btn-outline-primary btn-lg btn-block">upload</button>
                </div>
            </form>
        </div>
    </div>
