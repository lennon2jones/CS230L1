    ...
    <div class="my-auto upload-container">
        <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <img src="images/robot.png" onclick="triggered();" id="gallery-display">
            ...
            <div class="form-group">
                <textarea name="descript" id="descript" cols="30" rows="3" placeholder="Description" style="text-aligh: center"></textarea>    
            </div>
            <div class="form-group">
                    <button type="submit" name="gallery-submit" class="btn btn-outline-primary btn-lg btn-block">upload</button>
            </div>
        </form>
    </div>
</div>
